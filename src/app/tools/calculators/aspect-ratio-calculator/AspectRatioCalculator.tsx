      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="text-sm mb-8" aria-label="Breadcrumb">
          <ol className="list-none p-0 inline-flex">
            ...
            <li>
              <span className="text-gray-500" aria-current="page">Aspect Ratio Calculator</span>
            </li>
          </ol>
        </nav>

        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Aspect Ratio Calculator</h1>
          <p className="text-lg text-gray-600">Calculate dimensions and ratios for video, images, and screens.</p>
        </div>
